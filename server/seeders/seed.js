    ...
    const tracks = await Track.insertMany([
        {
            ...
            album: "album 1",
            audioSrc: 'http://localhost:3001/public/audio/apes.ogg',
            image: 'http://localhost:3001/public/images/bbcover.jpg',
            color: "#ff0000",
        },
        {
            title: 'acid drop',
            artist: "black's beach",
            album: "album 2",
            audioSrc: 'http://localhost:3001/public/audio/acid.ogg',
            image: 'http://localhost:3001/public/images/bbcover.jpg',
            color: "#00ff00",
        },
        {
            ...
            image: 'http://localhost:3001/public/images/logo.png',
            color: "#ff00ff",        
        },
        {
            title: 'bruh',
